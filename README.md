...
- 🧫 *Vulnerability Assessment* – Using tools like OpenVAS, Nessus, and Nmap [view Project](https://github.com/AwePeter/Web-Application-Vulnerability-Reconnaissance/blob/main/README.md)
